...
licks = [ [ [1,0.5*1.1], [1,0.5*0.9], [1, 0.5*1.1], [1, 0.5*0.9], [-1, 0.5*1.1], [-1, 0.5*0.9], [-1, 0.5*1.1], [-1, 0.5*0.9],[1,0.5], [0, 0.5], [-1, 0.5] ] ]
for i in range(4):
    lick = choice(licks)
    for note in lick:
        curr_note += note[0]
...
m.getStream(0, 50.0) >> "slow_blues.wav"